...
public class ShareLinkCreatePresenter extends BasePresenter<LinkCreateContact.IPushView> implements LinkCreateContact.Presenter {
    @Override
    public void onPush(LinkCreateRequest request) {
        ...
        L.v("json",json);
        OkGoUtils.getInstance().postData(mView, RemoteUrl.linkCreateUrl(),json , new TypeToken<BaseResponse<LinkArticle>>() {
